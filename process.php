 ...
 if(isset($_POST['signIn'])) {
      ...
      // $country = 'Nigeria';
       ...
       $country = $ipdata->geoplugin_countryName; 
        ...
        $sql = $conn->query("INSERT INTO viewers (id, name, email, dept, country, phone, signInTime) 
        VALUES(NULL, '$fullname', '$email', '$dept', '$country', ' $phoneNumber', NOW())");  
...
if($sql) {
    ...
    if(isset($_POST['addComment'])){
        ...
        $output =  ' <div class="d-flex flex-row container-fluid mb-1">
                        ...
                        <div class="col-12 country">'.$country.' <time class="date timeago" datetime=""></time>  </div>
                         </div>
                     </div>';
